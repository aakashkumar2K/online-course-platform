<?php 
include("../classes/manage_voice_message_class.php");
$voice_messages=new manage_voice_message_class;			// creating object of  manage_courses_class.php
$voice_message=$voice_messages->display_message();    //calling display_courses() method from manage_courses_class.php
...
.tab-card-header > .tab-content {
 ...
 <!-- ========================================================================================================================== -->
  ...
  <a class="navbar-brand text-white" href="../admin_main.php">AK EDU</a>
...
<!-- sidebar starts -->
        ...
        <div class="col-sm-2 col-md-2 sidebar badge-dark" style="margin:inherit;" id="sidebar" >
         <ul class="list-group text-white sidebar-list">
            ...
            <li class="list-group-item bg-dark "><a href="#">Manage  messages</a></li>
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#manage_voice_message">Manage_voice_message</a>
  </li>
 <!--  <li class="nav-item">
...
<?php foreach ($voice_message as $voice_message_list)
 {
	?>

<div>
    <?php echo $voice_message_list['voice_message_subject'] ?>
<audio autoplay muted controls id="audioCtr"></audio><br>
<script>document.getElementById('audioCtr').srcObject=</script><?php echo $voice_message_list['voice_message'] ; ?>
</div>
<?php } ?>
...
<!-- =========================================================================================== -->
 ...
 <!-- ========================================================================================================================== -->
  ...
  <div class="tab-pane container fade" id="manage_voice_message">
        ...
        <div class="tab-content" id="myTabContent">   <!-- tab content starts -->
          ...
          <div class="tab-pane fade show active p-3" id="one" role="tabpanel" aria-labelledby="one-tab">
            ...
            <div class="card-body col-md-12">
				  ...
				  <div class="card-header bg-danger text-light p-2 cardh2"><h3>POST NEW  MESSAGE</h3></div>
				  
				  <div class="card-body small" ">

				  <form action="voice_message_add.php" method="post" enctype="multipart/form-data" onsubmit="return validation()">
					    <div class="form-group">
					      <label for="email">message subject :</label>
					      <input type="text" class="form-control" id="c_name" placeholder="Enter message subject" name="message_subject">
					    ...
					    <div class="form-group">
					      ...
					      <label for="pwd">voice message</label>
                          <input type="text" class="form-control" id="c_desc" x-webkit-speech name="voice_message"/>
					      <input type="text" class="form-control" id="c_desc" placeholder="Enter Course Description" name="voice_message">
